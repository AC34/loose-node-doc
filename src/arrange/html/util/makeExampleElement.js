...
function makeExampleElement(comment,html_template,html_format){
  ...
  var code = makeElement(html_format.example,"","",avoidCaption(comment.description));
  var example = makeElement(html_format.example_wrap,"",html_template.item_example_class,cap+code);
  return example;
}
